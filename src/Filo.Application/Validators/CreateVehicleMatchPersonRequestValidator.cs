...
public class CreateVehicleMatchPersonRequestValidator : AbstractValidator<VehicleMatchPersonDto.CreateRequest>
{
    public CreateVehicleMatchPersonRequestValidator()
    {

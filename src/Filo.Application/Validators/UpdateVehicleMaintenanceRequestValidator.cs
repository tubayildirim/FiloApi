...
public class UpdateVehicleMaintenanceRequestValidator : AbstractValidator<VehicleMaintenanceDto.UpdateRequest>
{
    public UpdateVehicleMaintenanceRequestValidator()
    {
